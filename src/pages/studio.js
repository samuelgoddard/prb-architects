        ...
        >
          ...
          >
            ...
            <div className="flex flex-wrap -mx-4 md:-mx-3 md:mt-8 md:h-screen-inner" id="something">
              <div className="w-full md:w-1/2 lg:w-5/12 flex flex-wrap md:px-3">
              ...
              <div className="w-full md:w-1/2 lg:w-7/12 md:px-3 overflow-hidden">
                <div className="flex flex-wrap h-full">
            ...
            <div className="w-full flex flex-wrap items-end">
              ...
              <div className="w-full md:w-10/12 mx-4 md:mx-0 md:px-5">
                <div className="flex flex-wrap items-end relative">
                  ...
                  <div className="flex-wrap border-t border-b border-black w-full md:pr-0 md:max-w-xl lg:max-w-3xl lg:ml-8 mb-16 md:mb-40 lg:mb-40 hidden md:flex">
                    <a href={`mailto:${ this.props.data.studio.studioEmailAddress }`} rel="noopener noreferrer" target="_blank" className="text-sm sm:text-lg md:text-xl block py-2 lg:py-3 pr-3 lg:pr-4 leading-tight hover:line-through focus:line-through hover:text-white focus:text-white lg:mb-0 border-r border-black">Email</a>

                    <a href={`tel:${ this.props.data.studio.studioTelephone }`} rel="noopener noreferrer" target="_blank" className="text-sm sm:text-lg md:text-xl block pl-2 lg:pl-3 px-3 lg:px-4 py-2 lg:py-3 leading-tight hover:line-through focus:line-through hover:text-white focus:text-white lg:mb-0 border-r border-black">
                    ...
                    <Link to={`/journal`} className="text-sm sm:text-lg md:text-xl block leading-tight hover:line-through focus:line-through hover:text-white focus:text-white pl-3 lg:pl-4 py-2 lg:py-3 ml-auto border-l border-black">Journal</Link>
                  </div>
                </div>
