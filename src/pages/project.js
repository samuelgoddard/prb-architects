...
const ProjectPage = () => {
  return (
    <>
      ...
      >
        <div className="flex flex-wrap md:mb-16 -mx-4 md:-mx-3 -mt-40 md:mt-0">
          ...
          <div className="w-full md:w-1/2 lg:w-7/12 xl:w-8/12 flex flex-wrap md:px-3">
            ...
            <div className="mt-auto w-full px-4 md:px-0">
              <div className="flex flex-wrap items-end">
                ...
                <motion.div variants={item} className="ml-auto order-1 lg:order-2 mb-32 md:mb-0 mt-12 md:mt-0">
