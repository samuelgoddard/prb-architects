      ...
      <SEO title="Journal" />
        ...
        <motion.div initial="initial" animate="enter" exit="exit" variants={fade} className="bg-white p-4 md:p-6 pt-14 md:pt-22">
          ...
          >
            ...
            <h1 className="w-full md:flex-1 text-right text-screen-display--large m-0 p-0 block order-1 md:order-2 leading-none mt-2 mb-0 pb-0">Journal</h1>
          </motion.div>
        ...
        <motion.div variants={fade} className="w-full md:w-10/12 ml-auto mr-4 md:mr-6 px-4 md:px-0 md:pl-12 lg:pl-4">
          ...
          <ul className="flex flex-wrap border-t border-black border-b">
            ...
            <li className="ml-auto block border-l border-black">
              <a className="lg:text-lg xl:text-2xl py-2 md:py-3 px-2 lg:px-4 xl:px-5 block hover:text-white focus:text-white hover:line-through invert-select" href="mailto:hello@prb-a.com" target="_blank" rel="noopener noreferrer">hello@prb-a.com</a>
            </li>
            ...
            <li className="border-l border-black">
              <a className="lg:text-lg xl:text-2xl py-2 md:py-3 px-2 lg:px-4 xl:px-5 block hover:text-white invert-select focus:text-white hover:line-through" href="https://twitter.com/prbarchitects" target="_blank" rel="noopener noreferrer">Twi<span className="hidden md:inline invert-select">tter</span></a>
            </li>

            <li className="border-l border-black">
              <a className="lg:text-lg xl:text-2xl py-2 md:py-3 px-2 lg:px-4 xl:px-5 pr-0 lg:pr-0 xl:pr-0 block hover:text-white focus:text-white hover:line-through invert-select" href="https://www.instagram.com/prbarchitects/" target="_blank" rel="noopener noreferrer">Insta<span className="hidden md:inline invert-select">gram</span></a>
            </li>
          </ul>
