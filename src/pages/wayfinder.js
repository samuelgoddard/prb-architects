...
const GalleryIndexPage = ({ data: { work }, location }) => {
  return (
    <>
      ...
      <Div100vh>
        <motion.div initial="initial" animate="enter" exit="exit" variants={fade} className="bg-prbred p-4 md:p-6 h-full pt-16 md:pt-22">
          <motion.div
            initial="initial"
            animate="enter"
            exit="exit"
            ...
            <nav className="mt-auto mb-auto w-full">
              <ul>
                <motion.li variants={item}>
                  <Link className="text-black text-6xl md:text-7xl font-display leading-none pt-8 md:pt-12 pb-3 md:pb-6 border-b-2 border-black flex flex-wrap items-center hover:text-white hover:line-through focus:line-through
                  " to="/">
                ...
                <motion.li variants={item}>
                  <Link className="text-black text-6xl md:text-7xl font-display leading-none pt-8 md:pt-12 pb-3 md:pb-6 flex flex-wrap items-center hover:text-white hover:line-through focus:line-through
                  " to="/journal">
