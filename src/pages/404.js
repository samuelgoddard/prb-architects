        ...
        <nav className="relative z-10 w-full">
          <ul className="flex flex-wrap">
            <li className="ml-auto">
              <Link to="/" className="text-lg md:text-2xl px-px text-black invert-select line-through">Close</Link>
            </li>
          </ul>
        </nav>
        ...
        <motion.div initial="initial" animate="enter" exit="exit" variants={fade} className="bg-prbred p-4 md:p-6 h-full pt-14 md:pt-22">
          ...
          >
            <div className="text-center w-full mt-12">
              <h1 className="text-black block wayfinder-item font-display leading-none mb-0 pb-0 invert-select text-center w-full">This page does not exist</h1>
              <span className="text-black font-display leading-none invert-select text-lg md:text-xl text-center xl:text-2xl">Please navigate to our <Link to="/" className="underline">home page</Link> to find your bearings</span>
            </div>
