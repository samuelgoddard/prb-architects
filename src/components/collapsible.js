  ...
  return (
    <button className="Collapse w-full group" onClick={() => handleClick()}>
      <div className="flex flex-wrap items-center border-b border-current w-full py-3 md:py-6 xl:py-8">
        ...
        <span className={textLarge ? `block flex-1 text-xl md:text-2xl xl:text-3xl text-left font-display leading-extratight mb-0 pb-0 md:-mb-3 group-hover:line-through` : `block flex-1 text-xl md:text-2xl text-left font-display leading-extratight mb-0 pb-0 md:-mb-2 group-hover:line-through`}>{ heading }</span>
