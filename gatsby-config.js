...
module.exports = {
  ...
  plugins: [
    ...
    },
    {
      ...
      options: {
         features: [`Array.prototype.find`, `Object.assign`, `Promise`, `String.prototype.endsWith`, `Symbol`, `Symbol.for`, `WeakSet`, `Element.prototype.append`, `DocumentFragment.prototype.append`, `Array.prototype.forEach`]
      },
    },
